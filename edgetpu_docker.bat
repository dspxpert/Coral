...
if "%1" == "" docker run -it --rm -v %cd%:/home/edgetpu edgetpu_compiler
if not "%1"=="" docker run -it --rm -v %cd%:/home/edgetpu edgetpu_compiler edgetpu_compiler %1 %2 %3 %4 %5 %6 %7 %8 %9 
